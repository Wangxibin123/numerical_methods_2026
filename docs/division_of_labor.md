...
| **陈龙** | 23 信科 | 数据 pipeline：NYC TLC 下载 / 清洗 / zone-hour 聚合 / 特征工程 / cost 矩阵；OD median 兜底策略；附录 A/B/G 起草；视频 P1-P8 录制（含 λ 经济学依据） | ✅ |
| **汤平之** | 23 元培 | 报告与 Beamer 排版（含中文 ctex 字体调试）；图表整理；预测精度对比表；附录 C/F/J/L/M 起草；视频 P9-P15 录制 + PPT 录音合成 + MP4 导出 | ✅ |
